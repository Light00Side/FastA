...
#[derive(Debug)]
pub struct FastAPICoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FastAPICoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FastAPICore processing");
    
    let mut processor = FastAPICoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FastAPICoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FastAPICoreProcessor::new(false);
